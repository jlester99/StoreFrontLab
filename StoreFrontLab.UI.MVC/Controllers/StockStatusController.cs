...
namespace StoreFrontLab.UI.MVC.Controllers
{
    public class StockStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StockStatusID,Description")] StockStatus stockStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StockStatusID,Description")] StockStatus stockStatus)
        {
            if (ModelState.IsValid)
            {
